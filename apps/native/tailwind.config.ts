  ...
  theme: {
    extend: {
      colors: {
        ...
        "app-primary": { DEFAULT: "var(--app-primary)", light: "var(--app-primary-light)", dark: "var(--app-primary-dark)" },
        ...
        danger:   { DEFAULT: "var(--danger)", light: "var(--danger-light)", soft: "var(--danger-soft)" },
        warning:  { DEFAULT: "var(--warning)", light: "var(--warning-light)" },
        surface:  { DEFAULT: "var(--surface-base)", elevated: "var(--surface-elevated)", muted: "var(--surface-muted)" },
        star:     { DEFAULT: "var(--rating-default)", light: "var(--rating-light)" },
        status: {
