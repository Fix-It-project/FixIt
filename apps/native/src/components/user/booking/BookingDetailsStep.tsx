...
export default function BookingDetailsStep({
  ...
  return (
    ...
    >
      ...
      >
        {/* Date badge */}
        <View className="mb-4 rounded-xl bg-brand-light px-4 py-2.5">
          <Text
            className="text-center text-[13px] font-semibold text-brand"
        ...
        <View className="mb-4">
          ...
          <TextInput
            ...
            className="rounded-xl border border-edge-light bg-surface-white px-4 py-3 text-[14px] text-content"
            style={{
        ...
        <View className="mb-4">
          ...
          {attachment ? (
            <View className="overflow-hidden rounded-xl border border-edge-light">
              <Image
            ...
            <View className="flex-row gap-3">
              <TouchableOpacity
                onPress={pickImage}
                className="flex-1 flex-row items-center justify-center gap-2 rounded-xl border border-dashed border-edge-light bg-surface-white py-4"
                activeOpacity={0.7}
              >
                <Paperclip size={18} color={Colors.brand} strokeWidth={2} />
                <Text
