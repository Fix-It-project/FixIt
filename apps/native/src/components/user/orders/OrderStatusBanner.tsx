...
const BANNER_CONFIG: Record<OrderStatus, { label: string; color: string; bg: string; icon: typeof Clock }> = {
  pending: { label: "Waiting for technician to accept", color: "#d97706", bg: "#fffbeb", icon: Clock },
  accepted: { label: "Accepted by technician", color: Colors.success, bg: "#ecfdf5", icon: CheckCircle },
  rejected: { label: "Rejected by technician", color: Colors.error, bg: "#fef2f2", icon: XCircle },
  cancelled_by_user: { label: "Cancelled by you", color: Colors.error, bg: "#fef2f2", icon: XCircle },
  cancelled_by_technician: { label: "Cancelled by technician", color: Colors.error, bg: "#fef2f2", icon: AlertTriangle },
