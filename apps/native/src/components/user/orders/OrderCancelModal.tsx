  ...
  return (
    <Modal visible={visible} transparent animationType="fade" onRequestClose={onClose}>
      ...
      >
        <Pressable
          onPress={() => {}}
          style={{ width: "88%", backgroundColor: Colors.white, borderRadius: 20, padding: 20 }}
        >
          ...
          <Text style={{ fontSize: 14, color: Colors.textSecondary, lineHeight: 20, marginBottom: 16 }}>
            Are you sure you want to cancel the order with{" "}
          ...
          <View style={{ flexDirection: "row", gap: 10 }}>
            ...
            <TouchableOpacity
              ...
              style={{
                flex: 1, alignItems: "center", borderRadius: 14, paddingVertical: 12,
                backgroundColor: isLoading ? Colors.borderLight : Colors.error,
              }}
              activeOpacity={0.85}
            >
              {isLoading ? (
