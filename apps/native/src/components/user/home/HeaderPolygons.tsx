 ...
 * Includes a wave SVG path at the bottom to smooth the header-to-content transition.
 */
export default function HeaderPolygons() {
	...
	return (
		...
		>
			...
			{/* Wave divider — blends header into content area */}
			<Path
				d={`M 0,${HEIGHT - 20} C ${SCREEN_WIDTH * 0.35},${HEIGHT + 16} ${SCREEN_WIDTH * 0.65},${HEIGHT - 16} ${SCREEN_WIDTH},${HEIGHT - 20} L ${SCREEN_WIDTH},${HEIGHT} L 0,${HEIGHT} Z`}
				fill="#f3f4f6"
			/>
		</Svg>
	);
