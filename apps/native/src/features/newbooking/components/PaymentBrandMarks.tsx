...
import MastercardLogo from "@/src/assets/images/mastercard.svg";
...
// (visa ≈ 3.09:1, mastercard ≈ 1.51:1, meeza ≈ 2.07:1) so none distorts.
...
export function PaymentBrandMarks() {
	return (
		<View style={{ flexDirection: "row", alignItems: "center", gap: space[2] }}>
			...
			<MastercardLogo width={MARK_HEIGHT * 1.51} height={MARK_HEIGHT} />
