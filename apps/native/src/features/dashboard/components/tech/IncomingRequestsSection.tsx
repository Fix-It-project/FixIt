      ...
      <TouchableOpacity activeOpacity={0.95} onPress={() => openModal(item)}>
        ...
        >
          ...
          <Text
            ...
            style={{ color: Colors.primary, fontFamily: "GoogleSans_600SemiBold" }}
          >
            Tap to view details →
          </Text>
          ...
          <View className="flex-row gap-2">
            <TouchableOpacity
              ...
              style={{ backgroundColor: isBusy ? Colors.borderDefault : Colors.primary }}
              activeOpacity={0.85}
              disabled={isBusy}
            ...
            <TouchableOpacity
              ...
              style={{ borderColor: Colors.borderDefault, backgroundColor: isBusy ? Colors.surfaceElevated : Colors.surfaceBase }}
              activeOpacity={0.7}
              disabled={isBusy}
    ...
    <View className="mt-6">
      ...
      <View className="mb-3 flex-row items-center justify-between px-4">
        ...
        {pendingOrders.length > 0 && (
          ...
          >
            <Text style={{ fontSize: 10, color: Colors.surfaceBase, fontFamily: "GoogleSans_700Bold" }}>
