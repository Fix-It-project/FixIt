...
export default function HelpSupportContent({ description }: HelpSupportContentProps) {
  return (
    <ScrollView className="flex-1 bg-surface-elevated" contentContainerClassName="gap-4 px-5 py-6">
      <View className="rounded-2xl bg-surface px-5 py-6 shadow-sm" style={{ elevation: 2 }}>
        ...
        <Text className="mt-2 text-[14px] leading-5 text-content-muted">{description}</Text>
      </View>
