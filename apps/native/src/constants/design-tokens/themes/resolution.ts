...
export function getThemeVariableRecord(
	...
	return {
		...
		"--tint-hero-start": tokens.tint.heroStart,
		"--tint-hero-mid": tokens.tint.heroMid,
		"--tint-hero-end": tokens.tint.heroEnd,
		"--tint-on-hero": tokens.tint.onHero,
		"--tint-surface-strong": tokens.tint.surfaceStrong,
		"--tint-on-strong": tokens.tint.onStrong,
		"--tint-surface-soft": tokens.tint.surfaceSoft,
		"--tint-on-soft": tokens.tint.onSoft,
		"--tint-surface-faint": tokens.tint.surfaceFaint,
		"--tint-chip": tokens.tint.chip,
		"--tint-on-chip": tokens.tint.onChip,
