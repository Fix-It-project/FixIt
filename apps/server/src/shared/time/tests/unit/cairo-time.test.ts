...
import { nowInCairo, cairoMidnightUtc, hoursBetween, cairoDateString } from '../../cairo-time.js';
...
describe('cairoDateString', () => {
  it('returns the Cairo calendar day for a UTC instant just before midnight Cairo', () => {
    expect(cairoDateString(new Date('2026-05-01T20:00:00Z'))).toBe('2026-05-01');
    expect(cairoDateString(new Date('2026-05-01T22:00:00Z'))).toBe('2026-05-02');
  });
});
