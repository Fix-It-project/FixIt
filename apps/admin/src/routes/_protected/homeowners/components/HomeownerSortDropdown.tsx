...
import type { HomeownerSort } from "@/types";

const OPTIONS: { key: HomeownerSort; label: string }[] = [
	{ key: "newest", label: "Newly added" },
	{ key: "most_orders", label: "Most orders" },
	{ key: "most_spent", label: "Most spent" },
	{ key: "recent_order", label: "Most recent order" },
];

interface HomeownerSortDropdownProps {
	value: HomeownerSort;
	onChange: (value: HomeownerSort) => void;
}

export function HomeownerSortDropdown({ value, onChange }: HomeownerSortDropdownProps) {
